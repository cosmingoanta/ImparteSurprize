...
public class FortuneCookie implements ISurprise {
	...
	private String wisdomNumber;
	private static Random random = new Random();
	private static final String[] wisdom = { "Take out the fortune before you eat the cookie. - Author: Dave Barry",
	...
	private FortuneCookie(String wisdomNumber) {
		this.wisdomNumber = wisdomNumber;
	}

	static FortuneCookie generate() {
		FortuneCookie fortune = new FortuneCookie(FortuneCookie.wisdom[random.nextInt(wisdom.length)]);
		return fortune;
	}

	@Override
	public void enjoy() {
		System.out.println("This surprize contains a fortune cookie. The message inside says: " + this.wisdomNumber + ". Enjoy!");
	}
